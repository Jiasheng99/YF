                ...
                <div class="panel-body" style="padding:30px">
                    ...
                    <form method="post" action="/empresa/configure/{{$arrayEmpresas->id}}" enctype="multipart/from-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$arrayEmpresas['nombre']}}" name="nombre" id="nombre" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="codEmpresa">Codigo Empresa</label>
                            <input type="text" value="{{$arrayEmpresas['codEmpresa']}}" name="codEmpresa" id="codEmpresa" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="telefono">Telefono</label>
                            <input type="text" value="{{$arrayEmpresas['telefono']}}" name="telefono" id="telefono" class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$arrayEmpresas['email']}}" name="email" id="email" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="password">Password</label>
                            <input type="text" value="{{$arrayEmpresas['password']}}" name="password" id="password" class="form-control">
                        </div>
