...
<?php $total += $details['precio'] * $details['quantity'] ?>
        <tr>
          <td class="cantidad">{{ $details['quantity'] }}</td>
          <td class="producto">{{ $details['nombre'] }}</td>
          <td class="precio">{{ $details['precio'] }} € </td>
        </tr>
...
<p class="centrado1"> Total para pagar: <b>{{ $total }} €</b></p>
